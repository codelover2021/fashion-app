                    ...
                    <div class="tab__right">
                                ...
                                <div class="account__go">
                                    ...
                                    <div class="account__detal">
                                        ...
                                        <a href="#">Go to Consignment
                                            <svg onclick="openCity(event, 'profilepage__consignment')" width="37" height="16" viewBox="0 0 37 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M35.7642 8.70711C36.1547 8.31658 36.1547 7.68342 35.7642 7.29289L29.4002 0.928932C29.0097 0.538408 28.3766 0.538408 27.986 0.928932C27.5955 1.31946 27.5955 1.95262 27.986 2.34315L33.6429 8L27.986 13.6569C27.5955 14.0474 27.5955 14.6805 27.986 15.0711C28.3766 15.4616 29.0097 15.4616 29.4002 15.0711L35.7642 8.70711ZM0 9H35.0571V7H0L0 9Z"
                                                    fill="black" />
                                    ...
                                    <div class="order__box">
                                        <div class="order__box-detalis">
                                            ...
                                            <div class="box-detalis-prod">
                                                <div class="box-prod">
                                                    <img src="./assets/img/yeezyboost350v2black.jpg" alt="#" />
                                                    <p>Yeezy Boost 350 V2 YecheilYeezy</p>
                                                </div>
                                                <div class="box-prod">
                                                    <img src="./assets/img/yeezyboost350v2black.jpg" alt="#" />
                        ...
                        <div id="profilepage__consignment" class="tabcontent consignment" style="display: none">
                            <div class="consignment__section-wrapper">
                                <form id="msform" class="msform" action="{{route('consign')}}" method="post">
                                    @csrf
                                                ...
                                                <div class="selects">
                                                    <div class="select">
                                                        ...
                                                        <div class="custom-select__input">
                                                            ...
                                                            @endif
                                                            <input type="text" placeholder="First name" @if(Auth::user()->name) value="{{Auth::user()->name}} @endif" name="name"/>
                                                        </div>
                                                    </div>
                                                    <div class="select">
                                                        <div class="custom-select__title">
                                                        ...
                                                        <div class="custom-select__input">
                                                            @if ($errors->has('last_name'))
                                                                <span class="text-danger">{{ $errors->first('name') }}</span>
                                                            @endif
                                                            <input type="text" placeholder="Last name" @if(Auth::user()->last_name) value="{{Auth::user()->last_name}} @endif" name="last_name"/>
                                                        </div>
                                                    </div>
                                                    <div class="select">
                                                        <div class="custom-select__title">
                                                        ...
                                                        <div class="custom-select__input">
                                                            ...
                                                            @endif
                                                            <input type="email" placeholder="example@gmail.com" name="email" @if(Auth::user()->email) value="{{Auth::user()->email}} @endif" />
                                                        </div>
                                                    </div>
                                                    <div class="select">
                                                        <div class="custom-select__title">
                                                        ...
                                                        <div class="custom-select__input">
                                                            ...
                                                            @endif
                                                            <input type="tel" placeholder="+1 234 567 89" name="phone" @if(Auth::user()->phone) value="{{Auth::user()->phone}} @endif"/>
                                                        </div>
                                                    </div>
                                                    <div class="select">
                                                        <div class="custom-select__title">
                                                        ...
                                                        <div class="custom-select__input">
                                                            ...
                                                            @endif
                                                            <input type="number" placeholder="123" name="zip_code" @if(Auth::user()->zip_code) value="{{Auth::user()->zip_code}} @endif" />
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                                    </fieldset>--}}
                        ...
                        <div class="modal comments" data-modal="trigger-1">
                                    ...
                                    <div class="popUp-rate">
                                        <form action="#">
                                            <div class="rating__text">
                                                <textarea name="" id="" placeholder="Tell us about your experience"></textarea>
                                            </div>
                                            <div class="rating__uploadImg">
                                                <script>(function (e, t, n) { var r = e.querySelectorAll("html")[0]; r.className = r.className.replace(/(^|\s)no-js(\s|$)/, "$1js$2") })(document, window, 0);</script>
                                                <div class="box">
                                                    <input type="file" name="file-3[]" id="file-3"
                                                           accept="image/png, image/jpeg, image/webp" class="inputfile inputfile-3"
                                                           data-multiple-caption="{count} files selected" multiple />
                                                    <label for="file-3">
                                                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M17.3743 8.2793C17.4709 8.2793 17.5493 8.20117 17.5493 8.10449V7.28906H18.3645C18.4612 7.28906 18.5396 7.21094 18.5396 7.11426C18.5396 7.01758 18.4612 6.93945 18.3645 6.93945H17.5493V6.12402C17.5493 6.02734 17.4709 5.94922 17.3743 5.94922C17.2776 5.94922 17.1992 6.02734 17.1992 6.12402V6.93945H16.384C16.2874 6.93945 16.209 7.01758 16.209 7.11426C16.209 7.21094 16.2874 7.28906 16.384 7.28906H17.1992V8.10449C17.1992 8.20117 17.2776 8.2793 17.3743 8.2793Z"
                                                                fill="#303030" />
                                                            <path
                                                                d="M11.4204 15.8135C12.4968 15.8135 13.3723 14.9375 13.3723 13.8613C13.3723 12.7852 12.4968 11.9092 11.4204 11.9092C10.344 11.9092 9.46826 12.7852 9.46826 13.8613C9.46826 14.9375 10.344 15.8135 11.4204 15.8135ZM11.4204 12.2827C12.291 12.2827 12.9993 12.9907 12.9993 13.8613C12.9993 14.7319 12.291 15.4399 11.4204 15.4399C10.5498 15.4399 9.84131 14.7319 9.84131 13.8613C9.84131 12.9907 10.5498 12.2827 11.4204 12.2827Z"
                                                                fill="#303030" />
                                                            <path
                                                                d="M13.5534 13.0059C13.6602 13.271 13.7224 13.5589 13.7224 13.8618C13.7224 15.1313 12.6897 16.1636 11.4204 16.1636C10.1509 16.1636 9.11817 15.1313 9.11817 13.8618C9.11817 13.5589 9.18036 13.271 9.28717 13.0059H5.81006H5.45996V17.5415C5.45996 17.8223 5.68872 18.0508 5.96997 18.0508H16.8652C17.1494 18.0508 17.3806 17.8198 17.3806 17.5356V13.0059H17.0305H13.5534Z"
                                                                fill="#303030" />
                                                            <path
                                                                d="M16.8706 9.66895H13.937L13.3123 8.56055C13.2249 8.4043 13.0593 8.30762 12.8806 8.30762H9.95996C9.78125 8.30762 9.61572 8.4043 9.52857 8.56006L8.90332 9.66894H5.9646C5.68628 9.66894 5.45996 9.89502 5.45996 10.1733V12.6562H5.81006H9.46805C9.8743 12.001 10.5942 11.5601 11.4204 11.5601C12.2464 11.5601 12.9663 12.001 13.3725 12.6562H17.0305H17.3806V10.1787C17.3806 9.89746 17.1519 9.66895 16.8706 9.66895Z"
                                                                fill="#303030" />
                                                        </svg>
                                            ...
                                            <div class="rating__send glb-button">
                                                <input type="submit" value="Send">
                                            </div>
                                            <div class="rating__cancel">
                            ...
                            <a href="">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0)">
                                        ...
                                        <path
                                            d="M19.01 8.0127C18.0969 8.0127 17.2544 7.7102 16.5778 7.19988C15.8019 6.61488 15.2444 5.75676 15.0475 4.7677C14.9987 4.52332 14.9725 4.27113 14.97 4.0127H12.3615V11.1402L12.3584 15.0443C12.3584 16.088 11.6787 16.973 10.7365 17.2843C10.4631 17.3746 10.1678 17.4174 9.86029 17.4005C9.46779 17.3789 9.09997 17.2605 8.78029 17.0693C8.09997 16.6624 7.63872 15.9243 7.62622 15.0799C7.60654 13.7602 8.67341 12.6843 9.99216 12.6843C10.2525 12.6843 10.5025 12.7268 10.7365 12.8039V10.8558V10.1555C10.4897 10.1189 10.2384 10.0999 9.98435 10.0999C8.54091 10.0999 7.19091 10.6999 6.22591 11.7808C5.49654 12.5977 5.05904 13.6399 4.99154 14.7327C4.9031 16.1683 5.42841 17.533 6.44716 18.5399C6.59685 18.6877 6.75404 18.8249 6.91841 18.9514C7.79185 19.6236 8.85966 19.988 9.98435 19.988C10.2384 19.988 10.4897 19.9693 10.7365 19.9327C11.7872 19.7771 12.7565 19.2961 13.5215 18.5399C14.4615 17.6108 14.9809 16.3774 14.9865 15.0646L14.9731 9.23457C15.4215 9.58051 15.9118 9.86676 16.4381 10.0889C17.2565 10.4343 18.1244 10.6093 19.0175 10.6089V8.71488V8.01207C19.0181 8.0127 19.0106 8.0127 19.01 8.0127Z"
                                            fill="#2E2E2E" />
                                    </g>
                                    <defs>
                                        <clipPath id="clip0">
