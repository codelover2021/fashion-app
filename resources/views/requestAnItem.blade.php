                ...
                <div class="requestAnItemPage__section-wrapper">
                    ...
                    <div class="section__right">
                        <div class="section__right-requestForm">
                            ...
                            <form action="{{route('requestSend')}}" method="POST" enctype="multipart/form-data" class="requestForm">
                                @csrf
                                <div class="requestForm__name">
                                    ...
                                    @enderror
                                    <input id="request-name"  class="@error('name') is-invalid @enderror" value="{{ old('name') }}" name="request-username" type="text" />
                                </div>
