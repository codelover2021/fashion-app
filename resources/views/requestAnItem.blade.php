...
<div class="wrapper cBlack">
    ...
    <main class="page">
        <section class="page__section requestAnItemPage__section">
            <div class="requestAnItemPage__section-wrapper">
                ...
                <div class="section__right">
                    <div class="section__right-requestForm">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data" class="requestForm">
                            <div class="requestForm__input glb-input">
                                <p>First name</p>
                                <input id="request-name" name="request-username" type="text" />
                            </div>
                            <div class="requestForm__input glb-input">
                                <p>Last name</p>
                                <input id="request-lastName" name="request-userLastName" type="text" />
                            </div>
                            <div class="requestForm__input glb-input">
                                <p>Email</p>
                                <input id="request-email" name="request-useremali" type="email" />
                            </div>
                            <div class="requestForm__input glb-input">
                                <p>Phone number (optional)</p>
                                <input id="request-phone" name="request-userPhone" type="tel" />
                            </div>
                            <div class="requestForm__button glb-button">
                                <input id="request-send " type="submit" value="Continue">
                            </div>
                        </form>
                    </div>
                </div>
