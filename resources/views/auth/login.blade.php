            ...
            <div class="loginpage__section-wrapper">
                ...
                <div class="section__right">
                    <div class="section__right-loginForm">
                        ...
                        <form action="{{ route('login') }}"  method="post" enctype="multipart/form-data" class="loginForm">
                            @csrf
                            ...
                            <div class="loginForm__pass">
                                ...
                                @enderror
                                <input id="password" placeholder="Password" tabindex="2" name="password" type="password" />
                            </div>
                            <div class="loginForm__remem-forget">
                                <div class="loginForm__remem">
                                    <label class="container">
                                        Remember me
                                        <input id="rememberMe" type="checkbox" value="lgRememberMe" name="remember">
