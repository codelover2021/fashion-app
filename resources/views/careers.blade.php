            ...
            <section class="page__section carrerspage__section-2">
                <div class="section-2__wrapper">
                    <div class="section-2__box">
                        ...
                        <div class="box__text">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus in augue eget dolor
                                eget.</p>
                        </div>
                        <div class="box__collage">
                            <div class="collage__collum-1">
                                <picture>
                                    <source srcset="{{asset('img/carrerspage-collage-img1.webp')}}" type="image/webp">
                                    <img src="{{asset('img/carrerspage-collage-img1.jpg')}}" alt=""></picture>
                            </div>
                            <div class="collage__collum-2">
                                <picture>
                                    <source srcset="{{asset('img/carrerspage-collage-img2.webp')}}" type="image/webp">
                                    <img src="{{asset('img/carrerspage-collage-img2.jpg')}}'" alt=""></picture>
                                <picture>
                                    <source srcset="{{asset('img/carrerspage-collage-img3.webp')}}" type="image/webp">
                                    <img src="{{asset('img/carrerspage-collage-img3.jpg')}}'" alt=""></picture>
                            </div>
                            <div class="collage__collum-3">
                                <picture>
                                    <source srcset="{{asset('img/carrerspage-collage-img4.webp')}}" type="image/webp">
                                    <img src="{{asset('img/carrerspage-collage-img4.jpg')}}'" alt=""></picture>
                            </div>
                        </div>
                        <div class="box__text-2">
                            <p>If you need a reasonable accommodation because of a disability for any part of the
                                employment
                                process, please call
                                <a href="tel:+123-456-7890">123-456-7890</a> or send an e-mail to <a
                                    href="mailto:RentRunReturn@rrr.com">RentRunReturn@rrr.com</a> and let us know the
                                nature of your
