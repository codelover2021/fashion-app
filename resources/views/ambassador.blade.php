...
<div class="wrapper cBlack">
    ...
    <main class="page">
        <section class="page__section ambassador__section">
            <div class="ambassador__wrraper">
                <div class="ambassador__title">
                    <h1>Ambassador program</h1>
                </div>
                <div class="ambassador__text">
                    <h2>Application</h2>
                    <p>Apply today and start earning cash and store credit</p>
                </div>
                <div class="ambassador__about-container">
                    <div class="ambassador__about-title">
                        <h2>About you</h2>
                        <div class="hr"></div>
                    </div>
                    <div class="ambassador__about-form">
                        <form action="{{route('ambassadorSend')}}">
                            @csrf
                            <div class="glb-input ambassador__about-input">
                                <p>Name</p>
                                <input type="text"  id="" name="name" value="{{Auth::user()->name}}">
                            </div>
                            <div class="glb-input ambassador__about-input">
                                <p>Last name</p>
                                <input type="text"  id="" name="name" value="{{Auth::user()->last_name}}">
                            </div>
                            <div class="glb-input ambassador__about-input">
                                <p>Email</p>
                                    ...
                                    <div class="container">
                                        <div class="custom-select-wrapper">
                                            <div class="custom-select book-info__size">
                                                <div class="custom-select__trigger"><span>Where do you currently live</span>
                                                    <div class="arrow"></div>
                                                </div>
                                                <div class="custom-options">
                                                    <span class="custom-option selected" data-value="">live</span>
                                                    <span class="custom-option" data-value="">live</span>
                                                    <span class="custom-option" data-value="">live</span>
                                                    <span class="custom-option" data-value="">live</span>
                            ...
                            <div class="glb__remem ambassador__about-remem">
                                <label class="container">I am over the age of 18 years old
                ...
                <div class="ambassador__platform-container">
                    <div class="ambassador__platform-title glb-title">
                        <h2>Social platforms</h2>
                        <div class="hr"></div>
                    </div>

                    <div class="ambassador__platform-form">
                        <form action="#">
                            <div class="platform__inputs">
                                <div class="select  ambassador__platform-input">
                                    <div class="custom-select__title">
                                        <p>Social chanel</p>
                                    </div>
                                    <div class="content__accardion">
                                        <div class="container">
                                            <div class="custom-select-wrapper">
                                                <div class="custom-select book-info__size">
                                                    <div class="custom-select__trigger"><span>Social chanel</span>
                                                        <div class="arrow"></div>
                                                    </div>
                                                    <div class="custom-options">
                                                        <span class="custom-option selected" data-value="">chanel</span>
                                                        <span class="custom-option" data-value="">chanel</span>
                                                        <span class="custom-option" data-value="">chanel</span>
                                                        <span class="custom-option" data-value="">chanel</span>
                                ...
                                <div class="glb-input ambassador__platform-input">
                                    <p>Username or URL</p>
                                    <input type="text">
                                </div>
                                <div class="select  ambassador__platform-input">
                                    <div class="custom-select__title">
                                        <p>Social chanel 2 (optional)</p>
                                    </div>
                                    <div class="content__accardion">
                                        <div class="container">
                                            <div class="custom-select-wrapper">
                                                <div class="custom-select book-info__size">
                                                    <div class="custom-select__trigger"><span>Social chanel 2 (optional)</span>
                                                        <div class="arrow"></div>
                                                    </div>
                                                    <div class="custom-options">
                                                        <span class="custom-option selected" data-value="">chanel</span>
                                ...
                                <div class="select  ambassador__platform-input">
                                    <div class="custom-select__title">
                                        <p>Social chanel 3 (optional)</p>
                                    </div>
                                    <div class="content__accardion">
                                        <div class="container">
                                            <div class="custom-select-wrapper">
                                                <div class="custom-select book-info__size">
                                                    <div class="custom-select__trigger"><span>Social chanel 3 (optional)</span>
                                                        <div class="arrow"></div>
                                                    </div>
                                                    <div class="custom-options">
                                                        <span class="custom-option selected" data-value="">chanel</span>
                            ...
                            <div class="glb-button ambassador__platform-button">
                                <input type="submit" value="Submit">
                            </div>
                        </form>
                    </div>
                    <div class="ambassador__platform-info">
                        <p>By applying to the RRR Ambassador program, you agree to our <a href="#">Terms of Service</a>
                        </p>
                        <p>Please also read our <a href="#">Privacy Policy</a> </p>
                    </div>
                </div>
            </div>
        </section>
